//
//  MovieDBTableViewController.swift
...
class MovieDBTableViewController: UITableViewController {
    ...
    */
    ...
    func fetchMovies(){
        ...
        let url = NSURL(string: "https://api.themoviedb.org/3/movie/now_playing?api_key=\(apiKey)"+"&language=en-US&page=1")
